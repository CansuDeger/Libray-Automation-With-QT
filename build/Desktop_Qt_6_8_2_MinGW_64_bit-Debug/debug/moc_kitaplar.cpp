...
namespace {
struct qt_meta_tag_ZN8kitaplarE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN8kitaplarE = QtMocHelpers::stringData(
    "kitaplar"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8kitaplarE[] = {
...
Q_CONSTINIT const QMetaObject kitaplar::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8kitaplarE.offsetsAndSizes,
    qt_meta_data_ZN8kitaplarE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8kitaplarE_t,
        // Q_OBJECT / Q_GADGET
...
void *kitaplar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8kitaplarE.stringdata0))
